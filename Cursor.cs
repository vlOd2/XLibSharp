...
namespace X11
{
    ...
    public partial class Xlib
    {
        ...
        public static extern XStatus XDefineCursor(IntPtr display, XWindow window, XCursor cursor);
        ...
        /// <returns>zero on error</returns>
        [DllImport("libX11.so.6")]
        public static extern XStatus XUndefineCursor(IntPtr display, XWindow window);
        ...
        [DllImport("libX11.so.6")]
        public static extern XCursor XCreateFontCursor(IntPtr display, XFontCursor shape);
        ...
        /// <returns>Prepared cursor</returns>
        [DllImport("libX11.so.6")]
        public static extern XCursor XCreatePixmapCursor(IntPtr display, XPixmap source, XPixmap mask,
        ...
        /// <returns></returns>
        [DllImport("libX11.so.6")]
        public static extern XCursor XCreateGlyphCursor(IntPtr display, XFont source_font, XFont mask_font, uint source_char,
        ...
        /// <returns></returns>
        [DllImport("libX11.so.6")]
        public static extern XStatus XRecolorCursor(IntPtr display, XCursor cursor,
        ...
        /// <returns>zero on error</returns>
        [DllImport("libX11.so.6")]
        public static extern XStatus XFreeCursor(IntPtr display, XCursor cursor);
        ...
        /// <returns>zero on error</returns>
        [DllImport("libX11.so.6")]
        public static extern XStatus XQueryBestCursor (IntPtr display, XWindow drawable, uint width, uint height,
