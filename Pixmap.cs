...
namespace X11
{
    public partial class Xlib
    {
        ...
        public static extern XPixmap XCreatePixmap(IntPtr display, XWindow drawable, uint width, uint height, uint depth);
        ...
        [DllImport("libX11.so.6")]
        public static extern XStatus XFreePixmap(IntPtr display, XPixmap pixmap);
    }
}
